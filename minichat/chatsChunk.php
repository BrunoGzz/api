...
try {
    ...
    if (!isset($input->id) || empty($input->id) || !isset($input->offset) || !is_numeric(($input->offset))) {
    ...
    echo json_encode([
        ...
        'data' => [
            'user' => $userData,
            'chats' => $chats, // Reverse order to display oldest first
            'isTheEnd' => $isTheEnd,
            'section' => $section,
        ]
    ]);
